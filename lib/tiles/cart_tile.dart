...
class CartTile extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    Widget _buildContent() {
      //Execulta para atualizar os valores da tela
      CartModel.of(context).upddatePrices();
            ...
            child: Container(
              ...
              child: Column(
                ...
                children: <Widget>[
                  ...
                  Text(
                    "Horário: ${cartProduct.size}",
                    style: TextStyle(fontWeight: FontWeight.w300),
                  ),
                  Text(
                    "R\$ ${cartProduct.productData.price.toDouble().toStringAsFixed(2)}",
                    style: TextStyle(
